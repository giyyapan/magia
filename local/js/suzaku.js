...
(function() {
  var AjaxManager, Api, ApiManager, EventEmitter, KeybordManager, Suzaku, TemplateManager, Utils, Widget, debug,
  ...
  KeybordManager = (function(_super) {
    ...
    function KeybordManager() {
      return KeybordManager.__super__.constructor.apply(this, arguments);
    }
    ...
    KeybordManager.prototype.init = function() {
      ...
      window.onkeydown = function(evt) {
        var keyCode, name, _ref, _results;
