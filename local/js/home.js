...
(function() {
  ...
  HomeMenu = (function(_super) {
    ...
    function HomeMenu(floor) {
      ...
      this.floor = floor;
      this.functionBtns = [];
      console.log(this.floor, this.floor.game);
      this.backpackBtn = new BackpackBtn(this.floor.game, this);
  ...
  Floor = (function(_super) {
    ...
    Floor.prototype.initMenu = function() {
      ...
      moveCallback = function() {
        ...
        if (x === (_this.mainLayer.width - s.width)) {
      ...
      this.menu.UI['move-right'].onclick = function(evt) {
        ...
        if (_this.currentX > _this.mainLayer.width - s.width) {
          _this.currentX = _this.mainLayer.width - s.width;
        }
        x = _this.camera.getOffsetPositionX(_this.currentX, _this.mainLayer);
        if (x > _this.mainLayer.width) {
          x = _this.mainLayer.width;
        }
  ...
  FirstFloor = (function(_super) {
    ...
    function FirstFloor() {
      ...
      this.currentX = 400;
      this.camera.x = this.camera.getOffsetPositionX(this.currentX, this.mainLayer);
    }
        ...
        return _this.menu.on("activeSubMenu", function(buttonCode) {
          ...
          switch (buttonCode) {
            case 1:
              ...
              return _this.mainLayer.fadeOut("slow", function() {
                return _this.setCallback(1000, function() {
                  return _this.mainLayer.fadeIn("slow", function() {
                    var player;
                    box.close();
  ...
  window.Home = (function(_super) {
    ...
    Home.prototype.exit = function() {
      var layer, name, time, _ref,
        _this = this;
      time = "slow";
      _ref = this.firstFloor.layers;
      for (name in _ref) {
        layer = _ref[name];
        layer.fadeOut(time);
      }
