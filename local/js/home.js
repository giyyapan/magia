...
(function() {
  ...
  HomeMenu = (function(_super) {
    ...
    HomeMenu.prototype.hideFunctionBtns = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        btn = _ref[_i];
        _results.push(btn.J.addClass("animate-popout"));
      }
      return _results;
    };
  ...
  Floor = (function(_super) {
    ...
    Floor.prototype.initMenu = function() {
      ...
      moveCallback = function() {
        ...
        if (x === 0) {
          _this.menu.UI['move-left'].J.removeClass("animate-popup").addClass("animate-popout");
        } else {
          _this.menu.UI['move-left'].J.removeClass("animate-popout").addClass("animate-popup");
        }
        if (x === (_this.mainBg.width - s.width)) {
          return _this.menu.UI['move-right'].J.removeClass("animate-popup").addClass("animate-popout");
        } else {
          return _this.menu.UI['move-right'].J.removeClass("animate-popout").addClass("animate-popup");
        }
      };
