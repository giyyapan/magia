...
(function() {
  ...
  window.Drawable = (function(_super) {
    ...
    Drawable.prototype.onDrawBlend = function(content, timeDelay) {
      var item, tempContext, _i, _j, _len, _len1, _ref, _ref1;

      tempContext = this.secondCanvas.getContext;
      ...
      return this._handleBlend(tempContext, realContext);
    };
    ...
    Drawable.prototype._handleBlend = function(tempContext, realContext) {};
