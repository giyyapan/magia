...
(function() {
  var GatherResaultBox, MovePoint, Place, ResPoint,
  ...
  MovePoint = (function(_super) {
    __extends(MovePoint, _super);

    function MovePoint(place, tpl, data) {
      var parts, self,
        _this = this;
      this.place = place;
      this.area = place.area;
      parts = data.split(":");
      this.moveTarget = parts[0];
      this.x = parseInt(parts[1].split(",")[0]);
      this.y = parseInt(parts[1].split(",")[1]);
      this.guardians = null;
      MovePoint.__super__.constructor.call(this, tpl);
      if (this.moveTarget === "exit") {
        this.text = "离开";
      } else {
        this.text = this.area.originData.places[this.moveTarget].name;
      }
      this.UI.target.J.text(this.text);
      this.J.addClass("mp-" + this.moveTarget);
      this.J.css({
        left: "" + this.x + "px",
        top: "" + this.y + "px"
      });
    ...
    MovePoint.prototype.active = function(evt) {
      var box,
        _this = this;
      if (this.guardians) {
        evt.stopPropagation();
    ...
    MovePoint.prototype.setGuardians = function(data) {
      this.UI.guardians.J.show();
      return this.guardians = data.split(",");
    };
  ...
  Place = (function(_super) {
    ...
    Place.prototype.addMovePoint = function(data, index) {
      ...
      return point.appendTo(this.relativeMenu.UI['move-point-box']);
    };
