...
(function() {
  var DetailsBox, ReactionBox, ReactionBtn, ReactionConfirmBox, ReactionFinishBox, ReactionTraitsItem, SourceItem, WorktableMenu,
  ...
  ReactionFinishBox = (function(_super) {
    ...
    function ReactionFinishBox(reactionBox, db) {
      ...
      self = this;
      _ref = this.reactionBox.traitsItems;
      for (name in _ref) {
        i = _ref[name];
        if (!this.db.things.supplies.get("" + i.traitsName + "Potion")) {
        ...
        item.onclick = function() {
          return self.chooseTraitsItem(this);
        };
      }
      this.show();
    }

    ReactionFinishBox.prototype.chooseTraitsItem = function(item) {
  ...
  ReactionTraitsItem = (function(_super) {
    __extends(ReactionTraitsItem, _super);

    function ReactionTraitsItem() {
      ReactionTraitsItem.__super__.constructor.apply(this, arguments);
      this.J.addClass("animate-popup");
    }

    return ReactionTraitsItem;
  ...
  ReactionBtn = (function(_super) {
    ...
    function ReactionBtn(tpl, reaction, avail, reactionBox) {
      ...
      this.dom.onclick = function() {
        ...
        return _this.reactionBox.react(_this.reaction, function() {
          _this.J.addClass("animate-popout");
          return _this.remove();
        });
      };
    }
    ...
    ReactionBtn.prototype.remove = function() {
      ...
      scale = 0;
      return layer.animate((function(p) {
        var s;

        s = scale * (1 - p);
        return Utils.setCSS3Attr(_this, "animate", "scale(" + s + "," + s + ")");
      }), 1000, function() {
    ...
    ReactionBtn.prototype.update = function(avail) {
      ...
      if (this.avail) {
        ...
        span.J.text(Dict.TraitsName[this.reaction.to].split("")[0]);
        this.UI["?"].J.hide();
  ...
  ReactionBox = (function(_super) {
    ...
    function ReactionBox(tpl, menu) {
      ...
      this.UI['finish'].onclick = function() {
        ...
        box = new ReactionFinishBox(_this, _this.worktable.game.db);
        return box.on("getNewSupplies", function(s) {
          var i, n, _ref;

          _ref = _this.traitsItems;
          for (n in _ref) {
            i = _ref[n];
            i.remove();
          }
          ...
          return _this.worktable.game.player.getSupplies(s);
        });
      };
    ...
    ReactionBox.prototype.putInItem = function(playerItem) {
      ...
      for (name in _ref) {
        ...
        if (!this.traitsItems[name]) {
          this.traitsItems[name] = new ReactionTraitsItem(name, value).insertTo(this.UI['current-traits-list']);
        } else {
    ...
    ReactionBox.prototype.tryReaction = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (name in _ref1) {
          ...
          if (this.traitsItems[name].lv >= lvValue) {
            if (avail === 0) {
              avail = 2;
            }
          } else {
    ...
    ReactionBox.prototype.react = function(reaction, callback) {
      ...
      value = 0;
      for (name in reaction.from) {
        value += parseInt(this.traitsItems[name].traitsValue);
      }
      ...
      return box.on("accept", function() {
        ...
        return _this.combineTraitsItems(reaction, newTraits);
      });
    };

    ReactionBox.prototype.combineTraitsItems = function(reaction, newTraits) {
      var i, index, items, name, self, targetTop, _i, _len;

      self = this;
      items = [];
      for (name in reaction.from) {
        items.push(this.traitsItems[name]);
      }
      ...
      return window.setTimeout((function() {
        ...
        for (_j = 0, _len1 = items.length; _j < _len1; _j++) {
          i = items[_j];
          _results.push(i.J.animate({
            width: 0,
            margin: 0
          }, 200, function() {
            $(this).remove();
            return delete self.traitsItems[this.traitsName];
          }));
        }
        return _results;
      }), 400);
