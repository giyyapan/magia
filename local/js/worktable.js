...
(function() {
  var DetailsBox, ReactionBox, ReactionBtn, ReactionConfirmBox, ReactionTraitsItem, SourceItem, WorktableMenu,
  ...
  ReactionConfirmBox = (function(_super) {
    ...
    function ReactionConfirmBox(reaction) {
      ...
      ReactionConfirmBox.__super__.constructor.call(this, null);
      this.UI.title.J.text("合成");
      str = "";
