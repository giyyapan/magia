...
(function() {
  var DetailsBox, ReactionBox, ReactionBtn, SourceItem, WorktableMenu,
  ...
  ReactionBtn = (function(_super) {
    ...
    function ReactionBtn(tpl, reaction, avail, reactionBox) {
      ...
      this.dom.onclick = function() {
        ...
        return _this.reactionBox.react(_this.reaction);
      };
    }
    ...
    ReactionBtn.prototype.update = function(avail) {
      ...
      if (this.avail) {
        ...
        return span.J.text(Dict.TraitsName[this.reaction.to].split("")[0]);
      } else {
        return this.UI.target.J.hide();
      }
    };
  ...
  ReactionBox = (function(_super) {
    ...
    ReactionBox.prototype.react = function(reaction) {
      return console.log("react", reaction);
    };
