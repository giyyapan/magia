...
(function() {
  var BattlefieldMenu, Buff, DamageText, Debuff, DetailsBox, Dot, Hot, Shadow, SpellSourceItem,
  ...
  Hot = (function(_super) {
    ...
    function Hot(data) {
      Hot.__super__.constructor.call(this, null);
    }
  ...
  DamageText = (function(_super) {
    ...
    DamageText.prototype.draw = function(context) {
      ...
      return context.fillText(this.value, 0, -10);
    };
